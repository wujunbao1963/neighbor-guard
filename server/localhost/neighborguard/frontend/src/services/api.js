...
export const homeAPI = {
  ...
  // Phase 1B: House Mode
  updateMode: (circleId, houseMode) => api.put(`/homes/${circleId}/mode`, { houseMode }),
  updateNightMode: (circleId, data) => api.put(`/homes/${circleId}/night-mode`, data)
};

// ============================================================================
// Phase 1B: Integration API
// ============================================================================
export const integrationAPI = {
  getAll: (circleId) => api.get(`/integrations/${circleId}`),
  create: (circleId, data) => api.post(`/integrations/${circleId}`, data),
  update: (circleId, integrationId, data) => api.put(`/integrations/${circleId}/${integrationId}`, data),
  delete: (circleId, integrationId) => api.delete(`/integrations/${circleId}/${integrationId}`),
  regenerateToken: (circleId, integrationId) => api.post(`/integrations/${circleId}/${integrationId}/regenerate-token`)
};
...
export const sensorAPI = {
  getAll: (circleId, params) => api.get(`/sensors/${circleId}`, { params }),
  create: (circleId, data) => api.post(`/sensors/${circleId}`, data),
  update: (circleId, sensorId, data) => api.put(`/sensors/${circleId}/${sensorId}`, data),
  delete: (circleId, sensorId) => api.delete(`/sensors/${circleId}/${sensorId}`)
};
...
export const eventAPI = {
  ...
  // Phase 2: ML Feedback
  submitFeedback: (circleId, eventId, label, note) => api.post(`/events/${circleId}/${eventId}/feedback`, { label, note }),
  getFeedback: (circleId, eventId) => api.get(`/events/${circleId}/${eventId}/feedback`),
  getFeedbackStats: (circleId, days = 30) => api.get(`/events/${circleId}/feedback/stats`, { params: { days } })
};
